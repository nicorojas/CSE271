...
/**
 * Instructor is responsible for assigning final grades to students. An
 * Instructor is also able to view a list of classes they are teaching.
 * 
 * @author rojasnm
 */
public class Instructor extends AdminStaff {
	...
	/**
	 * Allows Instructor to assign a final grade (String grade) to a student
	 * (Student a).
	 * 
	 * @param a
	 * @param grade
	...
	/**
	 * Allows Instructor to have a class added to their list of classes being
	 * taught.
	 * 
	 * @param course
	 */
